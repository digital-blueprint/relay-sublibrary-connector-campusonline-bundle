...
* Rename `src/DbpRelaySublibraryConnectorCampusonlineBundle` and `DependencyInjection/DbpRelaySublibraryConnectorCampusonlineExtension` to match the new project name
...
For this create `config/packages/dbp_relay_sublibrary_connector_campusonline.yaml` in the app with the following
content:
